        ...
        public class Functions
        {
            ...
            void CheckShapeComponents(byte[] Data)
            {
                ...
                while (i <= fui2.header.fuiShapeComponentCount)
                {
                    ...
                    tl.FillInfo = (Data.Skip(offset).Take((int)0x24).ToArray());
                ...
                try
                {
                    ...
                    if (header.fuiTimelineCount > 0)
                    {
                        ...
                        while (i < header.fuiTimelineCount)
                        {
                            ...
                            TimelineCount.AddRange(fjui.timelines[i].Unknown);
                            TimelineCount.AddRange(fjui.timelines[i].Rectangle);
                            i++;
                        }
                    }
                    if (header.fuiTimelineActionCount > 0)
                    {
                        ...
                        while (i < header.fuiTimelineActionCount)
                        {
                            ...
                            TimelineActionCount.AddRange(fjui.timelineActions[i].Unknown);
                    ...
                    if (header.fuiShapeCount > 0)
                    {
                        ...
                        while (i < header.fuiShapeCount)
                        {
                            ...
                            ShapeCount.AddRange((fjui.shapes[i].Rectangle));
                            i++;
                        }
                    }
                    if (header.fuiShapeComponentCount > 0)
                    {
                        ...
                        while (i < header.fuiShapeComponentCount)
                        {
                            ...
                            ShapeComponentCount.AddRange((fjui.shapeComponents[i].FillInfo));
                    ...
                    if (header.fuiVertCount > 0)
                    {
                        ...
                        while (i < header.fuiVertCount)
                        {
                            ...
                            VertCount.AddRange(BitConverter.GetBytes(fjui.verts[i].x));
                            VertCount.AddRange(BitConverter.GetBytes(fjui.verts[i].y));
                            i++;
                        }
                    }
                    if (header.fuiTimelineFrameCount > 0)
                    {
                        ...
                        while (i < header.fuiTimelineFrameCount)
                        {
                            ...
                            TimelineFrameCount.AddRange(BitConverter.GetBytes(fjui.timelineFrames[i].Unknown1));
                            TimelineFrameCount.AddRange(BitConverter.GetBytes(fjui.timelineFrames[i].Unknown2));
                            i++;
                        }
                    }
                    if (header.fuiTimelineEventCount > 0)
                    {
                        ...
                        while (i < header.fuiTimelineEventCount)
                        {
                            ...
                            TimelineEventCount.AddRange(fjui.timelineEvents[i].Unknown);
                            TimelineEventCount.AddRange(fjui.timelineEvents[i].matrix);
                            TimelineEventCount.AddRange(fjui.timelineEvents[i].ColorTransform);
                            TimelineEventCount.AddRange(fjui.timelineEvents[i].Color);
                            i++;
                        }
                    }
                    ...
                    if (header.fuiReferenceCount > 0)
                    {
                        ...
                        while (i < header.fuiReferenceCount)
                        {
                            ...
                            ReferenceCount.AddRange(BitConverter.GetBytes(fjui.references[i].Unknown1));
                            ReferenceCount.AddRange(Encoding.ASCII.GetBytes(fjui.references[i].ReferenceName));
                            ReferenceCount.AddRange((fjui.references[i].Unknown2));
                            i++;
                        }
                    }
